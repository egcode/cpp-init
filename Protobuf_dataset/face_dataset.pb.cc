...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_face_5fdataset_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::dataset::Dataset, faces_),
};
...
const char descriptor_table_protodef_face_5fdataset_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ataset\022\034\n\005faces\030\001 \003(\0132\r.dataset.Face"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_face_5fdataset_2eproto = {
  false, false, descriptor_table_protodef_face_5fdataset_2eproto, "face_dataset.proto", 116,
...
bool Dataset::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(faces_)) return false;
  return true;
}
