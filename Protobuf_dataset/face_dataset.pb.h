...
class Dataset PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_face();
  ::dataset::Face* mutable_face(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dataset::Face >*
      mutable_face();
  private:
  const ::dataset::Face& _internal_face(int index) const;
  ::dataset::Face* _internal_add_face();
  public:
  const ::dataset::Face& face(int index) const;
  ::dataset::Face* add_face();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dataset::Face > face_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_face_5fdataset_2eproto;
};
// ===================================================================
...
// repeated .dataset.Face face = 1;
inline int Dataset::_internal_face_size() const {
  return face_.size();
}
inline int Dataset::face_size() const {
  return _internal_face_size();
}
inline void Dataset::clear_face() {
  face_.Clear();
}
inline ::dataset::Face* Dataset::mutable_face(int index) {
  // @@protoc_insertion_point(field_mutable:dataset.Dataset.face)
  return face_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dataset::Face >*
Dataset::mutable_face() {
  // @@protoc_insertion_point(field_mutable_list:dataset.Dataset.face)
  return &face_;
}
inline const ::dataset::Face& Dataset::_internal_face(int index) const {
  return face_.Get(index);
}
inline const ::dataset::Face& Dataset::face(int index) const {
  // @@protoc_insertion_point(field_get:dataset.Dataset.face)
  return _internal_face(index);
}
inline ::dataset::Face* Dataset::_internal_add_face() {
  return face_.Add();
}
inline ::dataset::Face* Dataset::add_face() {
  // @@protoc_insertion_point(field_add:dataset.Dataset.face)
  return _internal_add_face();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::dataset::Face >&
Dataset::face() const {
  // @@protoc_insertion_point(field_list:dataset.Dataset.face)
  return face_;
}
